...
int main(int argc, char* argv[])
{
    ...
    int thread_num = -1;
    int alg_num = 1;
    printf("Matrix sample rev1.2 for tunning experiments. Improved by Raymond, based on the sample from VTune\r\n");
    printf("Usage: matrix [thread_num] [algorithm no]\r\n");
    ...
    printf("Collected thread no %d, algorithm no %d\r\n", thread_num, alg_num);
    ...
    GetModelParams(&thread_num, 0, alg_num, 1);
    ...
    ParallelMultiply(NUM, a, b, c, t, thread_num, alg_num);
